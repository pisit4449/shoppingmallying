...
class _CreateAccountState extends State<CreateAccount> {
        ...
        if (formKey.currentState!.validate()) {
          if (typeUser == null) {
            ...
            MyDialog().normalDialog(
                context, 'ยังไม่เลือกชนิด User', 'กรุณาเลือกชนิด User');
          } else {
      ...
      if (value.toString() == 'null') {
        ...
        if (file == null) {
          ...
          String apiSaveAvatar =
              '${MyConstant.domain}/shoppingmallying/saveAvatar.php?';
          ...
          await Dio().post(apiSaveAvatar, data: data).then((value) {
            avatar = '/shoppingmallying/avatar/$nameAvatar';
            processInsertMySQL(
                name: name,
                address: address,
                phone: phone,
  ...
  Future<Null> processInsertMySQL(
    ...
    String apiInsertUser =
        '${MyConstant.domain}/shoppingmallying/insertUser.php?isAdd=true&name=$name&type=$typeUser&address=$address&phone=$phone&user=$user&password=$password&avatar=$avatar&lat=$lat&lng=$lng';
